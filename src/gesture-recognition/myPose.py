...
class myPose:
        ...
        if results.pose_landmarks:
            self.mp_drawing.draw_landmarks(
                ...
                landmark_drawing_spec=self.mp_drawing.DrawingSpec(
                    color=(255, 225, 255), thickness=3, circle_radius=3
                ),
    ...
    def checkPose_LRC(self, image, results):
        ...
        if (leftShoulder_x < image_mid_width) and (
            rightShoulder_x < image_mid_width
        ):
            LRC = "L"
        elif (leftShoulder_x > image_mid_width) and (
            rightShoulder_x > image_mid_width
        ):
            LRC = "R"
        else:
    ...
    def checkPose_JSD(self, image, results):
        ...
        cv2.line(
            image,
            (0, self.shoudler_line_y),
            (image_width, self.shoudler_line_y),
            (0, 255, 255),
            2,
        )
    ...
    def checkPose_Clap(self, image, results):
        ...
        cv2.putText(
            image, CLAP, (10, 30), cv2.FONT_HERSHEY_PLAIN, 2, (255, 255, 0), 3
        )
