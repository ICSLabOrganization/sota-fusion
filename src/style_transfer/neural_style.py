...
class NeuralStyle :
    def __init__(self) -> None:
        ...
        self.IMG_PATH = ASSETS_PATH.joinpath("output2.png")
        self.MODEL_PATH = Path(__file__).parent.joinpath("saved_models")

    # check_paths and train functions are used to train models, uncomment and paste them here if you want to use
        
    
    def __call__(self, args_content_image, args_model, args_cuda):
        ...
        if args_model.endswith(".onnx"):
            ...
            with torch.no_grad():
                ...
                style_model.eval()
                # right now we don't use self-create model so we don't need these
                # if args.export_onnx:
        ...
        utils.save_image(self.IMG_PATH, output[0])
...
def main():
    ...
    # train_args is used for training models, uncomment and paste here for usage

    # there's a back up for eval_arg lines in archives
...
# check_paths and train functions are used to train models, uncomment and paste them up there if you want to use
...
# train_args is used for training models, uncomment these and paste up there for usage
...
# eval_args in here are for back-up purpose
