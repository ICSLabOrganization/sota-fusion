...
def get_moveOver_event(ID:int, event=None):
    ...
    if ID == 0:
        ...
        new_content_image = get_movingOver_image(image_PIL=img_content_PIL, 
        ...
        new_style_image = get_movingOver_image(image_PIL=img_style_PIL, 
...
def get_movingOver_image(image_PIL: Image, text_canvasItem: int=None, event=None):
    if "Enter" in event:
...
image_content_canvas = canvas.create_image(
    205.0,
    136.0,
    image=img_content
)
...
image_style_canvas = canvas.create_image(
    205.0,
    368.0,
    image=img_style
)
...
button_canvas = canvas.create_image(
    615.0,
    442.0,
    image=img_btn
)
...
########################static gui##############################
canvas.tag_bind(button_canvas, '<Button-1>', lambda event: get_click_event(ID=0, event=str(event)))
canvas.tag_bind(button_canvas, '<Enter>',    lambda event: get_moveOver_event(ID=0, event=str(event)))
canvas.tag_bind(button_canvas, '<Leave>',    lambda event: get_moveOver_event(ID=0, event=str(event)))

canvas.tag_bind(image_content_canvas, '<Button-1>', lambda event: get_click_event(ID=1, event=str(event)))
canvas.tag_bind(image_content_canvas, '<Enter>',    lambda event: get_moveOver_event(ID=1, event=str(event)))
canvas.tag_bind(image_content_canvas, '<Leave>',    lambda event: get_moveOver_event(ID=1, event=str(event)))

canvas.tag_bind(image_style_canvas, '<Button-1>', lambda event: get_click_event(ID=2, event=str(event)))
canvas.tag_bind(image_style_canvas, '<Enter>',    lambda event: get_moveOver_event(ID=2, event=str(event)))
canvas.tag_bind(image_style_canvas, '<Leave>',    lambda event: get_moveOver_event(ID=2, event=str(event)))
